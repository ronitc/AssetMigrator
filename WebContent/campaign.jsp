                ...
                <head>
                    ...
                    <body>
                            ...
                            <nav class="navbar navbar-default">
                                <div class="container-fluid">
                                    <ul class="nav navbar-nav">
                                        ...
                                        <li class=""><a href="form.jsp">Form</a>
                                        </li>
										<li class="active"><a href="campaign.jsp">Campaign</a>
                                        </li>
                                    </ul>
                                </div>
                            </nav>
                        ...
                        <div class="container form-body">
                            ...
                            <form action="FetchCampaign" method="POST">
                                <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <form>
                                                    <div class="form-group">
                                                        ...
                                                        <input type="campaign_name" class="form-control" id="campaign_name" disabled="disabled" placeholder="campaign_Name " name="campaign_name" Value="${campaign.name}" />
                                                    </div>

                                                    <div class="form-group">
                                                        <label for="campaign_id">ID</label>
                                                        <input type="campaign_id" class="campaign-control" id="campaign_id" disabled="disabled" placeholder="ID" name="Id" Value="${campaign.id}" />
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="campaign_Created_At">Created At</label>
                                                        <input type="campaign_Created_At" class="campaign-control" id="campaign_Created_At" disabled="disabled" placeholder="Created At " name="created_at" Value="${campaign.createdAt}" />
                                                    </div>
