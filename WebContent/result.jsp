                            ...
                            <form action="Fetchemail" method="POST">
                                <div class="row">
                                    <div class="container-fluid" id="option">
                                        ...
                                        <button id="getmail" Name="btnFetch">GetMail</button><br><br>
		...
		<div class="col-md-6">
			<form>
		                        <div class="form-group">
                                    ...
                                    <input type="email_name" class="form-control" id="email_name" disabled="disabled" placeholder="Email_Name " name="email_name" Value="${email.name}" />
                                </div>

                                <div class="form-group">
                                    <label for="email_id">ID</label>
                                    <input type="email_id" class="form-control" id="email_id" disabled="disabled" placeholder="ID" name="Id" Value="${email.id}" />
                                </div>
                                <div class="form-group">
                                    <label for="email_Created_At">Created At</label>
                                    <input type="email_Created_At" class="form-control" id="email_Created_At" disabled="disabled" placeholder="Created At " name="created_at" Value="${email.createdAt}" />
                                </div>
		...
		<div class="col-md-6">
						<form>
		                        <div class="form-group">
                                    ...
                                    <input type="targetEmailGroup" class="form-control" id="targetEmailGroup" disabled="disabled" placeholder="targetEmailGroup " name="email_name" Value="${email.emailGroupId}" />
                                </div>

                                <div class="form-group">
                                    <label for="TargetRootFolder">TargetRootFolder</label>
                                    <input type="targetRootFolder" class="form-control" id="TargetRootFolder" disabled="disabled" placeholder="TargetRootFolder" name="TargetRootFolder" Value="Test_Ronit" />
                                </div>
                                <div class="form-group">
                                    <label for="TargetBounceBack">TargetBounceBack</label>
                                    <input type="TargetBounceBack" class="form-control" id="TargetBounceBack" disabled="disabled" placeholder="TargetBounceBack " name="TargetBounceBack" Value="${email.bounceBackEmail}" />
                                </div>

                                <div class="form-group">
                                    <label for="TargetReplyBackAddress">Target Reply To Address</label>
                                    <input type="TargetReplyToAddress" class="form-control" id="TargetReplyToAddress" disabled="disabled" placeholder="TargetReplyToAddress " name="TargetReplyToAddress" Value="${email.replyToEmail}" />
                                </div>
                                <div class="form-group">
                                    <label for="TargetSenderAddress">Target Sender Address</label>
                                    <input type="TargetSenderAddress" class="form-control" id="TargetSenderAddress" disabled="disabled" placeholder="TargetSenderAddress " name="TargetSenderAddress" Value="${email.senderEmail}" />
                                </div>
                                <div class="form-group">
                                    <label for="TargetSenderName">Target Sender Name</label>
                                    <input type="TargetSenderName" class="form-control" id="TargetSenderName" disabled="disabled" placeholder="TargetSenderName " name="TargetSenderName" Value="${email.senderName}" />
                                </div>
                                <%-- <div class="form-group">
                                    <label for="Bounce_back_email">Bounce Back Email</label>
                                    <input type="Bounce_back_email" class="form-control" id="Bounce_back_email" disabled="disabled" placeholder="Bounce_back_email" name="Bounce_back_email" Value="${email.bounceBackEmail}" />
	 ...
	 <div class="container-fluid" id="option">
                                <div class="pull-right">
                                    <form action="Fetchemail" method="POST">
											...
											<input type="text" placeholder="Object to Migrate " required="required" name="inputId" id="btnMigrateId" Value="${email.id}">
